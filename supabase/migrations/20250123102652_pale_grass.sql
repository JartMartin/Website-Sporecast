...
-- Create or update special_commodities table
DO $$ 
BEGIN
...
-- Ensure Wheat V2 exists in special_commodities
...
-- Ensure RLS policy exists for special_commodities
DROP POLICY IF EXISTS "Special commodities are viewable by everyone" ON special_commodities;
