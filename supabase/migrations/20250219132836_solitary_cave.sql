...
BEGIN
  ...
  DROP POLICY IF EXISTS "Companies insertable during registration" ON companies;
...
CREATE POLICY "company_registration_insert_policy"
  ON companies FOR INSERT
  TO public
  WITH CHECK (true);

CREATE POLICY "company_member_select_policy"
...
CREATE POLICY "company_admin_update_policy"
...
CREATE POLICY "invite_view_policy"
...
CREATE POLICY "invite_create_policy"
...
CREATE POLICY "invite_update_policy"
