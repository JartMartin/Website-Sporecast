...
CREATE TABLE wheat_metrics_1w (
  ...
  CONSTRAINT valid_volatility_stadium_1w
    CHECK (volatility_stadium IN ('low', 'moderate', 'high')),
  CONSTRAINT valid_trend_status_1w
    CHECK (trend_status IN ('increasing', 'stable', 'decreasing'))
);
...
ALTER TABLE wheat_metrics_4w 
  RENAME CONSTRAINT valid_volatility_stadium_1w TO valid_volatility_stadium_4w;
ALTER TABLE wheat_metrics_4w 
  RENAME CONSTRAINT valid_trend_status_1w TO valid_trend_status_4w;
...
ALTER TABLE wheat_metrics_12w 
  RENAME CONSTRAINT valid_volatility_stadium_1w TO valid_volatility_stadium_12w;
ALTER TABLE wheat_metrics_12w 
  RENAME CONSTRAINT valid_trend_status_1w TO valid_trend_status_12w;
...
ALTER TABLE wheat_metrics_26w 
  RENAME CONSTRAINT valid_volatility_stadium_1w TO valid_volatility_stadium_26w;
ALTER TABLE wheat_metrics_26w 
  RENAME CONSTRAINT valid_trend_status_1w TO valid_trend_status_26w;
...
ALTER TABLE wheat_metrics_52w 
  RENAME CONSTRAINT valid_volatility_stadium_1w TO valid_volatility_stadium_52w;
ALTER TABLE wheat_metrics_52w 
  RENAME CONSTRAINT valid_trend_status_1w TO valid_trend_status_52w;
